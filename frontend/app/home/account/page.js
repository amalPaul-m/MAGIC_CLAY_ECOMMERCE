                    ...
                    <form className="w-full max-w-md">
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full cursor-pointer h-12 border bg-white border-gray-300 rounded-xl py-2 pr-10 pl-3 focus:outline-none focus:ring-2 focus:ring-black appearance-none"
                            >
